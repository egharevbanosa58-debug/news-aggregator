...
export default function NewsCard({ article }) {
    return (
            <div className="feeds bg-white dark:bg-blue-900 gap-3 grid grid-cols-1 md:grid-cols-2 rounded-lg shadow hover:shadow-md overflow-hidden hover:scale-105 transition-transform duration-300 relative">
                ...
                <div className="py-6 px-4 ">
                    ...
                    <p className="mt-2 text-stone-500 dark:text-stone-300">Author: {article.author || "Unknown"}</p>
